...
public:
	...
	bool setPassword(const std::string & oldPassword, const std::string & password);
	void resetPassword();
	...
	bool sendChatMessage(AbstractUser * recipient, const std::string & topic, const std::string & content);
